...
const SCORE_TABLE = {
  rummikub: {
    wood:        { 2:[260,0], 3:[210,180,0], 4:[200,160,160,0] },
    iron:        { 2:[240,0], 3:[200,160,0], 4:[180,160,140,0] },
    bronze:      { 2:[220,0], 3:[180,150,0], 4:[170,140,130,0] },
    silver:      { 2:[200,0], 3:[170,130,0], 4:[160,120,120,0] },
    gold:        { 2:[180,0], 3:[150,120,0], 4:[140,120,100,0] },
    platinum:    { 2:[120,0], 3:[110,70,0], 4:[100,80,60,0] },
    emerald:     { 2:[80,0], 3:[80,40,0], 4:[80,40,40,0] },
    diamond:     { 2:[40,0], 3:[50,10,0], 4:[50,20,10,0] },
    master:      { 2:[20,0], 3:[30,0,0], 4:[40,0,0,0] },
    grandmaster: { 2:[10,-30], 3:[10,-10,-30], 4:[20,0,-20,-40] },
    challenger:  { 2:[-20,-60], 3:[-20,-40,-60], 4:[-10,-30,-50,-70] },
  },
  davinci: {
    wood:        { 2:[240,0], 3:[200,160,0], 4:[180,160,140,0] },
    iron:        { 2:[200,0], 3:[170,130,0], 4:[160,120,120,0] },
    bronze:      { 2:[160,0], 3:[140,100,0], 4:[130,100,90,0] },
    silver:      { 2:[160,0], 3:[140,100,0], 4:[130,100,90,0] },
    gold:        { 2:[140,0], 3:[120,90,0], 4:[120,80,80,0] },
    platinum:    { 2:[100,0], 3:[90,60,0], 4:[90,60,50,0] },
    emerald:     { 2:[60,0], 3:[60,30,0], 4:[60,40,20,0] },
    diamond:     { 2:[20,0], 3:[30,0,0], 4:[40,0,0,0] },
    master:      { 2:[20,0], 3:[30,0,0], 4:[40,0,0,0] },
    grandmaster: { 2:[10,-30], 3:[10,-10,-30], 4:[20,0,-20,-40] },
    challenger:  { 2:[-20,-60], 3:[-20,-40,-60], 4:[-10,-30,-50,-70] },
  },
  uno: {
    wood:        { 2:[220,0], 3:[180,150,0], 4:[170,140,130,0] },
    iron:        { 2:[180,0], 3:[150,120,0], 4:[140,120,100,0] },
    bronze:      { 2:[140,0], 3:[120,90,0], 4:[120,80,80,0] },
    silver:      { 2:[100,0], 3:[90,60,0], 4:[90,60,50,0] },
    gold:        { 2:[80,0], 3:[80,40,0], 4:[80,40,40,0] },
    platinum:    { 2:[60,0], 3:[60,30,0], 4:[60,40,20,0] },
    emerald:     { 2:[40,0], 3:[50,10,0], 4:[50,20,10,0] },
    diamond:     { 2:[20,0], 3:[30,0,0], 4:[40,0,0,0] },
    master:      { 2:[10,-30], 3:[10,-10,-30], 4:[20,0,-20,-40] },
    grandmaster: { 2:[0,-40], 3:[0,-20,-40], 4:[10,-10,-30,-50] },
    challenger:  { 2:[-20,-60], 3:[-20,-40,-60], 4:[-10,-30,-50,-70] },
  },
  splendor: {
    wood:        { 2:[300,0], 3:[240,210,0], 4:[220,200,180,0] },
    iron:        { 2:[260,0], 3:[210,180,0], 4:[200,160,160,0] },
    bronze:      { 2:[240,0], 3:[200,160,0], 4:[180,160,140,0] },
    silver:      { 2:[220,0], 3:[180,150,0], 4:[170,140,130,0] },
    gold:        { 2:[180,0], 3:[150,120,0], 4:[140,120,100,0] },
    platinum:    { 2:[140,0], 3:[120,90,0], 4:[120,80,80,0] },
    emerald:     { 2:[100,0], 3:[90,60,0], 4:[90,60,50,0] },
    diamond:     { 2:[60,0], 3:[60,30,0], 4:[60,40,20,0] },
    master:      { 2:[10,-30], 3:[10,-10,-30], 4:[20,0,-20,-40] },
    grandmaster: { 2:[10,-30], 3:[10,-10,-30], 4:[20,0,-20,-40] },
    challenger:  { 2:[-20,-60], 3:[-20,-40,-60], 4:[-10,-30,-50,-70] },
  },
