...
const SCORE_TABLE = {
  rummikub: {
    ...
    master:      { 2:[145,-260], 3:[190,-95,-260], 4:[240,205,-145,-340] },
    grandmaster: { 2:[140,-300], 3:[190,-125,-300], 4:[235,200,-175,-340] },
    challenger:  { 2:[140,-365], 3:[185,-170,-365], 4:[230,195,-220,-365] },
  },
  davinci: {
    wood:        { 2:[150,0], 3:[200,65,0], 4:[250,215,15,0] },
    iron:        { 2:[135,-40], 3:[180,60,-40], 4:[225,185,10,-20] },
    bronze:      { 2:[120,-80], 3:[160,55,-80], 4:[200,160,5,-45] },
    silver:      { 2:[120,-80], 3:[160,55,-80], 4:[200,160,5,-45] },
    gold:        { 2:[120,-105], 3:[160,40,-105], 4:[200,160,-10,-70] },
    platinum:    { 2:[115,-145], 3:[155,10,-145], 4:[195,155,-40,-110] },
    emerald:     { 2:[115,-185], 3:[150,-20,-185], 4:[190,150,-70,-150] },
    diamond:     { 2:[110,-225], 3:[150,-50,-225], 4:[185,145,-100,-190] },
    master:      { 2:[110,-225], 3:[150,-50,-225], 4:[185,145,-100,-270] },
    grandmaster: { 2:[110,-265], 3:[145,-80,-265], 4:[180,140,-130,-270] },
    challenger:  { 2:[105,-330], 3:[140,-125,-330], 4:[175,135,-175,-295] },
  },
  uno: {
    wood:        { 2:[140,0], 3:[185,65,0], 4:[230,195,15,0] },
    iron:        { 2:[125,-40], 3:[165,60,-40], 4:[205,165,10,-20] },
    bronze:      { 2:[110,-80], 3:[145,55,-80], 4:[180,140,5,-45] },
    silver:      { 2:[105,-120], 3:[140,25,-120], 4:[175,135,-25,-85] },
    gold:        { 2:[105,-145], 3:[140,10,-145], 4:[175,135,-40,-110] },
    platinum:    { 2:[105,-170], 3:[140,-5,-170], 4:[175,135,-55,-135] },
    emerald:     { 2:[105,-195], 3:[140,-20,-195], 4:[175,135,-70,-160] },
    diamond:     { 2:[105,-220], 3:[140,-35,-220], 4:[175,135,-85,-185] },
    master:      { 2:[100,-260], 3:[135,-65,-260], 4:[170,130,-115,-185] },
    grandmaster: { 2:[100,-285], 3:[135,-80,-285], 4:[170,130,-130,-210] },
    challenger:  { 2:[100,-325], 3:[130,-110,-325], 4:[165,125,-160,-290] },
  },
  splendor: {
    wood:        { 2:[190,0], 3:[250,65,0], 4:[315,270,15,0] },
    iron:        { 2:[175,-40], 3:[230,60,-40], 4:[290,250,10,-30] },
    bronze:      { 2:[170,-60], 3:[225,55,-60], 4:[280,240,5,-45] },
    silver:      { 2:[170,-85], 3:[225,40,-85], 4:[280,240,-10,-70] },
    gold:        { 2:[165,-125], 3:[220,10,-125], 4:[275,235,-40,-110] },
    platinum:    { 2:[160,-165], 3:[215,-20,-165], 4:[270,230,-70,-150] },
    emerald:     { 2:[160,-205], 3:[210,-50,-205], 4:[265,225,-100,-190] },
    diamond:     { 2:[155,-245], 3:[210,-80,-245], 4:[260,220,-130,-230] },
    master:      { 2:[155,-330], 3:[205,-140,-330], 4:[255,215,-190,-320] },
    grandmaster: { 2:[155,-330], 3:[205,-140,-330], 4:[255,215,-190,-320] },
    challenger:  { 2:[150,-395], 3:[200,-185,-395], 4:[250,210,-235,-385] },
  },
};
...
const MAFIA_EV4 = {   // 4인 기준 기대값(티어별) — 사용자 제시값
  wood:120, iron:100, bronze:90, silver:80, gold:70, platinum:50,
