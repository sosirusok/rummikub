...
const SCORE_TABLE = {
  rummikub: {
    wood:        { 2:[120,0], 3:[150,90,0], 4:[220,160,140,0] },
    iron:        { 2:[130,-10], 3:[160,90,-10], 4:[210,160,130,-20] },
    bronze:      { 2:[120,-20], 3:[150,90,-30], 4:[210,140,130,-40] },
    silver:      { 2:[130,-30], 3:[160,90,-40], 4:[200,140,120,-60] },
    gold:        { 2:[120,-40], 3:[150,90,-60], 4:[190,140,110,-80] },
    platinum:    { 2:[110,-50], 3:[130,60,-70], 4:[160,100,80,-100] },
    emerald:     { 2:[100,-60], 3:[120,50,-80], 4:[140,80,60,-120] },
    diamond:     { 2:[90,-70], 3:[100,30,-100], 4:[120,60,40,-140] },
    master:      { 2:[70,-70], 3:[100,30,-100], 4:[110,50,30,-150] },
    grandmaster: { 2:[60,-80], 3:[70,10,-110], 4:[90,20,10,-160] },
    challenger:  { 2:[40,-80], 3:[50,-20,-120], 4:[50,-10,-30,-170] },
  },
  davinci: {
    wood:        { 2:[120,0], 3:[150,90,0], 4:[210,140,130,0] },
    iron:        { 2:[110,-10], 3:[140,80,-10], 4:[190,120,110,-20] },
    bronze:      { 2:[100,-20], 3:[120,60,-30], 4:[170,100,90,-40] },
    silver:      { 2:[110,-30], 3:[130,60,-40], 4:[170,120,90,-60] },
    gold:        { 2:[100,-40], 3:[140,70,-60], 4:[170,100,90,-80] },
    platinum:    { 2:[90,-50], 3:[110,50,-70], 4:[150,80,70,-100] },
    emerald:     { 2:[80,-60], 3:[100,40,-80], 4:[130,60,50,-120] },
    diamond:     { 2:[70,-70], 3:[100,30,-100], 4:[110,40,30,-140] },
    master:      { 2:[70,-70], 3:[100,30,-100], 4:[110,50,30,-150] },
    grandmaster: { 2:[60,-80], 3:[70,10,-110], 4:[90,20,10,-160] },
    challenger:  { 2:[40,-80], 3:[50,-20,-120], 4:[50,-10,-30,-170] },
  },
  uno: {
    wood:        { 2:[100,0], 3:[140,70,0], 4:[190,140,110,0] },
    iron:        { 2:[90,-10], 3:[130,60,-10], 4:[170,120,90,-20] },
    bronze:      { 2:[80,-20], 3:[120,60,-30], 4:[150,100,70,-40] },
    silver:      { 2:[70,-30], 3:[100,30,-40], 4:[130,80,50,-60] },
    gold:        { 2:[80,-40], 3:[110,40,-60], 4:[130,60,50,-80] },
    platinum:    { 2:[70,-50], 3:[100,30,-70], 4:[120,60,40,-100] },
    emerald:     { 2:[80,-60], 3:[90,20,-80], 4:[110,60,30,-120] },
    diamond:     { 2:[70,-70], 3:[100,30,-100], 4:[110,40,30,-140] },
    master:      { 2:[50,-70], 3:[70,0,-100], 4:[80,30,0,-150] },
    grandmaster: { 2:[60,-80], 3:[70,10,-110], 4:[70,20,-10,-160] },
    challenger:  { 2:[40,-80], 3:[50,-20,-120], 4:[50,-10,-30,-170] },
  },
  splendor: {
    wood:        { 2:[140,0], 3:[180,120,0], 4:[250,180,170,0] },
    iron:        { 2:[130,-10], 3:[160,90,-10], 4:[230,160,150,-20] },
    bronze:      { 2:[140,-20], 3:[170,100,-30], 4:[220,160,140,-40] },
    silver:      { 2:[130,-30], 3:[160,90,-40], 4:[210,160,130,-60] },
    gold:        { 2:[120,-40], 3:[150,90,-60], 4:[190,140,110,-80] },
    platinum:    { 2:[110,-50], 3:[140,80,-70], 4:[170,120,90,-100] },
    emerald:     { 2:[100,-60], 3:[120,50,-80], 4:[150,100,70,-120] },
    diamond:     { 2:[90,-70], 3:[110,50,-100], 4:[130,80,50,-140] },
    master:      { 2:[50,-70], 3:[70,0,-100], 4:[80,30,0,-150] },
    grandmaster: { 2:[60,-80], 3:[70,10,-110], 4:[90,20,10,-160] },
    challenger:  { 2:[40,-80], 3:[50,-20,-120], 4:[50,-10,-30,-170] },
  },
