...
(function () {
  ...
  const MOB_TYPES = {
    ...
    blaze: { name: '블레이즈', kind: 'blaze', color: 0xe8a020, hp: 600, dmg: 50, xp: 35, coins: 8, speed: 2.0, books: ['fire_aspect', 'thunderlord'], drops: [{ key: 'blaze_rod', n: 1 }, { key: 'talisman_lava_charm', n: 1, chance: 0.02 }], tierCap: 4 },   // V79: 위키 — 블레이즈 막대 100%
    ...
    chicken: { name: '닭', kind: 'quad', color: 0xf2f2f2, hp: 30, dmg: 0, xp: 3, coins: 1, speed: 1.2, scale: 0.5, passive: true, books: [], drops: [{ key: 'raw_chicken', n: 1 }, { key: 'feather', n: 1 }, { key: 'talisman_feather', n: 1, chance: 0.005 }], tierCap: 0 },   // V75: 위키 — 생닭+깃털 100%
