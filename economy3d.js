...
(function () {
  ...
  const MOB_TYPES = {
    ...
    redstone_pigman: { name: '레드스톤 피그맨', kind: 'humanoid', color: 0xc86a6a, hp: 400, dmg: 42, fixedStats: true,   /* V96: 딥캐번 레드스톤 고정몹 */ xp: 24, coins: 8, speed: 2.0, books: ['fortune', 'efficiency'], drops: [{ key: 'redstone', n: 3, chance: 0.5 }, { key: 'gold_nugget', n: 2, chance: 0.5 }], tierCap: 3 },   /* V103: 위키 실측 — 레드스톤 0-5 @50%, 골드 너겟 0-2 @50%(고정 3개 아님) */
    ...
    blaze: { name: '블레이즈', kind: 'blaze', color: 0xe8a020, hp: 600, dmg: 50, xp: 35, coins: 8, speed: 2.0, books: ['fire_aspect', 'thunderlord'], drops: [{ key: 'blaze_rod', n: 1 }, { key: 'blaze_rod', n: 1, chance: 0.5 }, { key: 'talisman_lava_charm', n: 1, chance: 0.02 }], tierCap: 4 },   /* V104: 위키 실측 — 블레이즈 막대 1-2(100%/50%) */   // V79: 위키 — 블레이즈 막대 100%
    wither_skeleton: { name: '위더 스켈레톤', kind: 'tall', color: 0x2a2a2a, hp: 900, dmg: 65, xp: 45, coins: 10, speed: 2.2, books: ['titan_killer', 'dragon_hunter'], drops: [{ key: 'bone', n: 1 }, { key: 'coal', n: 1, chance: 0.5 }, { key: 'enchanted_coal', n: 1, chance: 0.01 }], tierCap: 4 },   /* V104: 위키 실측 — 뼈 100% + 석탄 50% + 인챈티드 석탄 1% */
    magma_cube: { name: '마그마 큐브', kind: 'slime', color: 0xd2541f, hp: 350, dmg: 35, xp: 22, coins: 6, speed: 1.5, books: ['hardened', 'thorns'], drops: [{ key: 'magma_cream', n: 1 }, { key: 'magma_cream', n: 1, chance: 0.66 }, { key: 'magma_cream', n: 1, chance: 0.33 }, { key: 'blaze_rod', n: 1, chance: 0.15 }], tierCap: 3 },   /* V104: 위키 실측 — 마그마 크림 1-3(100%) */   // V79: 위키 — 마그마 크림 100%(컬렉션 공급원)
    ...
    obsidian_defender: { name: '흑요석 수호자', kind: 'tall', color: 0x2a2040, hp: 500, dmg: 29, fixedStats: true,   /* V96: 엔드 Lv55 고정몹(워처 쌍) */ xp: 30, coins: 8, speed: 1.8, books: ['protection', 'hardened'], drops: [{ key: 'obsidian', n: 2 }, { key: 'obsidian', n: 1, chance: 0.5 }, { key: 'enchanted_obsidian', n: 1, chance: 0.01 }], tierCap: 5 },   /* V104: 위키 실측 — 흑요석 다수 + 인챈티드 흑요석 1% */
    ...
    chicken: { name: '닭', kind: 'quad', color: 0xf2f2f2, hp: 30, dmg: 0, xp: 3, coins: 1, speed: 1.2, scale: 0.5, passive: true, books: [], drops: [{ key: 'raw_chicken', n: 1 }, { key: 'feather', n: 1 }, { key: 'egg', n: 1, chance: 0.3 }, { key: 'talisman_feather', n: 1, chance: 0.005 }], tierCap: 0 },   /* V104: 위키 실측 — 생닭·깃털 100% + 달걀 30% */   // V75: 위키 — 생닭+깃털 100%
    sheep: { name: '양', kind: 'quad', color: 0xe9ecec, hp: 50, dmg: 0, xp: 4, coins: 2, speed: 1.0, passive: true, books: [], drops: [{ key: 'raw_mutton', n: 1 }, { key: 'wool_white', n: 1 }], tierCap: 0 },   // V75: 위키 — HP50, 생양고기+흰 양털 100%
