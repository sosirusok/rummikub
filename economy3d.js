...
(function () {
  ...
  const MOB_TYPES = {
    ...
    spider: { name: '거미', kind: 'spider', color: 0x3a3040, hp: 120, dmg: 35, xp: 6, coins: 2, speed: 2.4, books: ['bane_of_arthropods', 'triple_strike'], drops: [{ key: 'string', n: 1 }, { key: 'spider_eye', n: 1, chance: 0.5 }], tierCap: 1 },   // V77: 위키 — HP120/DMG35, 실100%+거미눈50%
