...
(function () {
  ...
  def('acacia_log', { kor: '아카시아나무 원목', hard: 2.0, tool: AXE, level: 0, pal: ['#a8907c', '#8a7060', '#b8a08c'], ring: '#4a3020', tex: 'log' });
  def('jungle_log', { kor: '정글나무 원목', hard: 2.0, tool: AXE, level: 0, pal: ['#5a4530', '#4a3824', '#6b5438'], ring: '#8a6f4a', tex: 'log' });
  ...
  def('acacia_planks', { kor: '아카시아나무 판자', hard: 2.0, tool: AXE, level: 0, pal: ['#b56b3a', '#a05a2c', '#c47c48'], tex: 'plank' });
  def('jungle_planks', { kor: '정글나무 판자', hard: 2.0, tool: AXE, level: 0, pal: ['#b09858', '#a08848', '#c0a868'], tex: 'plank' });
  ...
  def('acacia_leaves', { kor: '아카시아나무 잎', hard: 0.2, tool: SHEARS, level: 0, transparent: true, drops: [{ i: 'sapling', c: 1, chance: 0.06 }], pal: ['#8fa050', '#7c8c40', '#a0b060'], tex: 'leaves' });
  def('jungle_leaves', { kor: '정글나무 잎', hard: 0.2, tool: SHEARS, level: 0, transparent: true, drops: [{ i: 'sapling', c: 1, chance: 0.06 }], pal: ['#3a8c30', '#2f7a28', '#48a03a'], tex: 'leaves' });
  def('terracotta',  { kor: '테라코타', hard: 1.25, tool: PICK, level: 0, pal: ['#a35c3a', '#8f4c2e', '#b8724c'], tex: 'noise' });
